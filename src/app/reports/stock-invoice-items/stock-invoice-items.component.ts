...
export class ReportsStockInvoiceItemsComponent {
  ...
  private getStockInvoiceItems() {
    this.mservice.getStockInvoiceItems(this.parameters).subscribe({
      next: (v: any) => {
        //console.log(v);
        this.invoiceItems = v;
