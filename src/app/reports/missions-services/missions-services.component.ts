...
@Component({
  selector: 'app-reports-missions-services',
  imports: [DatePipe, DecimalPipe, NgFor, NgIf],
  templateUrl: './missions-services.component.html',
  styleUrl: '../reports.css'
})
export class ReportsMissionsServicesComponent {
  ...
  private getMissions() {
    this.mservice.getMissionsLite(this.parameters).subscribe({
      next: (v: any) => {
        //console.log(v);
        this.missions = v;
        //this.flattenData()
